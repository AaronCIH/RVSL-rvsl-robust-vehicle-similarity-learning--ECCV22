# %%
##############################################
# Construction FVRID BaseDataset: [FVRID_syn, FVRID_real, FVRID_clear]
# IMG: FVRID name
# NAME: Image name
...
# read label file
FVRID_CSV = pd.read_csv(r'./FVRID.csv')

# source dirs
def check_dir(dir):
    if not os.path.isdir(dir):
        print("Alert! ", dir, " data source is not complete!")
VERIWILD_dir = r'../../VeriWild/images_all/'  # check_path
VEHICLE1M_dir = r'../../Vehicle1M/image/'     # check_path
...
SAVE_FOLDER = ['../../FVRID_syn/train_clear', '../../FVRID_syn/query_clear', '../../FVRID_syn/gallery_clear',
               ...
               '../../FVRID_clear/train_clear', '../../FVRID_clear/query_clear', '../../FVRID_clear/gallery_clear']
for folder in SAVE_FOLDER:
    if not os.path.isdir(folder):
        os.makedirs(folder)

# Processing: create FVRID base dataset.
